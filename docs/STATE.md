...
## Siguiente
- **F4 — Cierre**: ensamblado del brief completo en una sola pantalla a partir de los 8 pasos del store, export `.md` descargable + copiar. Es el entregable del producto (principio §6.6 N11: el brief es el clímax).
